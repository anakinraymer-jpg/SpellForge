...
public static class GameData
{
    ...
    public static readonly IReadOnlyDictionary<string, ModDef> DefaultGlobalMods =
        new Dictionary<string, ModDef>
        {
            ...
            ["Duration: Instant"]    = new("Duration",  0, 1, "The spell effect is immediate. Does not affect spell level."),
            ["Duration: 1d6 Phases"] = new("Duration",  1, 1, "The spell effect lasts 1d6 phases."),
            ["Duration: Xd6 Phases"] = new("Duration",  2, 1, "The spell effect lasts a number of phases equal to the total rolled."),
            ["Duration: 1 Round"]    = new("Duration",  2, 1, "The spell effect lasts one full round."),
            ["Duration: X Rounds"]   = new("Duration",  3, 1, "The spell effect lasts a number of rounds equal to the total rolled."),
            ["Duration: Scene"]      = new("Duration",  5, 1, "The spell effect lasts the duration of the scene."),
